...
\begin{frame}{CC1 : Comment et quoi ?}
  \begin{block}{Horaire}
    \vspace{0pt}
    \textbf{Lundi 3 novembre 13h30-15h30} (CPES : 13h45-15h45, tiers-temps : 16h10) en \alert{A1, A5, Lav01, 2V80}
  \end{block}
  \pause
  \begin{block}{Contenu}
    \vspace{-0.25em}
...
\begin{frame}[fragile]{Mutabilité, immutabilité}
  ...
  \begin{block}{Rappel}
    \vspace{0pt}
  Une fonction \alert{ne peut pas modifier} une variable de type \mintinline{python}{int} donnée en argument :
\vspace{-0.5em}
  \begin{mdframed}[roundcorner=5pt]
  \begin{minted}{python}
