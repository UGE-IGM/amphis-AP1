...
subtitle:  "Notes de cours Semaine 3"
titlepage: true
author: "Team AP1"
date: \today
lang: "fr"
...
![*Diagramme d'exécution d'une double boucle*](img/while2.png){width=40%}
...
![*Rappel : diagramme d'exécution d'une boucle while*](img/while3.png){width=30%}
...
![*Une métaphore*](img/commode_liste.png)

![*Un peu plus proche de la réalité*](img/schema_list_py.png)
